      ...
      if test -s ${source_work_directory}/filtered_newly_created_file.tmp; then
        if test ${index_only} -eq 0; then
          ...
          if test -s ${work_directory}/processed_file.txt; then
            ...
            ./met_pre_bufr_to_tile_dataset.py --debug ${local_work_directory}/${process_prefix}.txt ${local_work_directory} 1>${local_work_directory}/${process_prefix}/${now}.txt.tmp 2>>${local_work_directory}/${process_prefix}_stderr.log
...
process_prefix=sub_bufr_to_tile_dataset
