                    ...
                    for property_key in property_dict.keys():
                        ...
                        if re.match(r'^U wind component$', property_key[8]):
                            ...
                            if out_file in out_name_dict:
                                out_name_dict[out_file] = out_name_dict[out_file] + [re.sub(r'U wind component', 'wind speed [m s-1]', property_key[8]), re.sub(r'U wind component', 'wind direction [degree]', property_key[8])]
                                ...
                                out_name_dict[out_file] = [re.sub(r'U wind component', 'wind speed [m s-1]', property_key[8]), re.sub(r'U wind component', 'wind direction [degree]', property_key[8])]
