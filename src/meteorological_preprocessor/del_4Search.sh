  ...
  if test -s ${work_directory}/${priority}_${search_index_directory}_date_hour_directory.tmp; then
    for date_hour_directory in `cat ${work_directory}/${priority}_${search_index_directory}_date_hour_directory.tmp`; do
      ...
      if test -s ${work_directory}/${priority}_${search_index_directory}_file.tmp; then
        ...
        rm -f ${work_directory}/${priority}_${search_index_directory}_file.tmp
      fi
      ...
      rm -f ${work_directory}/${priority}_${search_index_directory}_index.tmp
      rm -rf ${work_directory}/${search_index_directory}/${priority}/${date_hour_directory}
    done
    rm -f ${work_directory}/$${priority}_${search_index_directory}_date_hour_directory.tmp
  fi
}
cron=0
